...
def mainMenuWindow(menu):
    ...
    Label(menu, text="Uploading\nMedical Documents\nMade Easy", bg='#3E636E',fg=bgColor3,font=(font, 20, "bold")).place(x=225, y=760, anchor="nw")
    Label(menu, text="View\nMedical Documents\nAnywhere. AnyTime", bg='#3E636E',fg=bgColor3,font=(font, 20, "bold")).place(x=610, y=760, anchor="nw")
    Label(menu, text="All Your \nMedical Files\nIn One Place", bg='#3E636E',fg=bgColor3,font=(font, 20, "bold")).place(x=1030, y=760, anchor="nw")
    Label(menu, text="Share With\nMedical Professionals", bg='#3E636E',fg=bgColor3,font=(font, 20, "bold")).place(x=1360, y=760, anchor="nw")
...
def profileWindow():
    ...
    Button(profile, text="RETURN", command=profile.withdraw, bg=bgColor2, fg='white', borderwidth=0,
           font=(font, 12, 'bold')).place(x=30, y=110, anchor="nw")
...
def uploadWindow():
    ...
    Frame(upload, bg=bgColor3).place(relx=0.25, rely=0.3, relwidth=0.5, relheight=0.6)

    #label_file_explorer

    Label(upload, text="Documents",bg=bgColor3, fg=bgColor, font=(font, 25, "bold", )).place(x=960, y=350, anchor="center")

    Button(upload, text="Upload Files", command=img, bg=bgColor, fg='white', font=(font, 20, 'bold')).place(x=880, y=450, anchor="nw")
    Button(upload, text="View Files", command=filesWindow, bg=bgColor, fg='white', font=(font, 20, 'bold')).place(x=890,y=600,anchor="nw")
...
def filesWindow():
    ...
    Button(files, text='Files', command=img).pack()
